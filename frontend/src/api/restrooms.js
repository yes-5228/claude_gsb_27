...
export const restroomApi = {
  ...
  changeStatus: (id, payload) => http.post(`${RESOURCE}/${id}/status`, payload),
  statusEvents: (id) => http.get(`${RESOURCE}/${id}/status-events`),
  suspensions: (id) => http.get(`${RESOURCE}/${id}/suspensions`),
};
